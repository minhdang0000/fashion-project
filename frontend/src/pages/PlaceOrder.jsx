        ...
        <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
          ...
          <div className='flex gap-3'>
           ...
           <input required onChange={onChangeHandler} name='email' value={formData.email} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="email" placeholder='Email' />
            <input required onChange={onChangeHandler} name='street' value={formData.street} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Đường phố' />
          <div className='flex gap-3'>
            ...
            <input required onChange={onChangeHandler} name='state' value={formData.state} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Tình trạng' />
          </div>
          <div className='flex gap-3'>
          ...
          <div className='mt-12'>
            ...
            <div className='flex gap-3 flex-col lg:flex-row'>
              ...
              <div onClick={()=>setMethod('cod')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
                ...
                <p className='text-gray-700 text-sm font-medium mx-4'>Thanh toán khi nhận hàng</p>
              </div>
            </div>
